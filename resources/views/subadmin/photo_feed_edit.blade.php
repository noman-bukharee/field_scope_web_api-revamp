...
@push('page_level_css')
    ...
    <link type="text/css" href="{{asset("assets/image-editor/dist/tui-image-editor.css")}}" rel="stylesheet" />
@endpush
...
@push('page_level_scripts')
    ...
    <script type="text/javascript" src="{{asset("assets/image-editor/dist/tui-image-editor.js")}}"></script>
{{--    <script src="libs/code-snippet.min.js"></script>   --}}
    ...
    <script type="text/javascript">
        ...
        var whiteTheme = {
            ...
            // download button
            'downloadButton.backgroundColor': '#0082f1',
        ...
        var imageEditor = new tui.ImageEditor('#tui-image-editor-container', {
            includeUI: {
                loadImage: {
                    path: "{{URL::to('uploads/media/'.$data['pMedia']['path']."?".$data['pMedia']['updated_at'] )}}",
                    name: 'SampleImage',
                },
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#save').on('click', function (e) {
                ...
                console.log('blob',blob,imageEditor.toDataURL());
                ...
                formData.append('image', blob, 'sampleimage.png');
