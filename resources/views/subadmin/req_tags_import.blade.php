...
<div class="row nomargin" id="top">
    <div class="col-md-6">
    <h1 class="main-heading">Import Req. Photos Tags</h1>
    </div>
    <div class="col-md-6">
        <div class="container">
            <!-- Trigger the modal with a button -->
            <a href="{{URL::to('subadmin/cat_tag/export/template')}}" class="btn btn-add btn-pmadd-modified" >Download Sample</a>
        </div>
    </div>
</div>
<div class="container">
    <div class="col-md-12 form-group pull-right">
        ...
        <form id="import_form" action="{{URL::to('subadmin/cat_tag/import')}}" method="POST" enctype="multipart/form-data">
            {{csrf_field()}}
            <div class="row">
            <div class="col-md-4">
