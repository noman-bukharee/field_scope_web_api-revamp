...
//        $pdf->SetHeaderData(public_path('assets/images/report/logo.png'), ``, PDF_HEADER_TITLE . ' 001', PDF_HEADER_STRING, array(0, 64, 255), array(0, 64, 128));
